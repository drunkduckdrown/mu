...
import { Alert, Collapse, Progress, Tag, Tooltip } from '@arco-design/web-react';
...
export default function ContextPanel({ events }: { events: Activity[] }) {
  ...
  return (
    <div className='px-12px pb-8px text-13px shrink-0' data-testid='kyrn-context'>
      <div className='flex items-center gap-12px'>
        <div className='flex-1 min-w-0'>
          ...
          {view.percent !== undefined && (
            <Progress percent={view.percent} size='small' formatText={(value) => percent(value)} />
          )}
      ...
      {view.compacting && <Alert className='mt-8px' type='info' content={t('common.kyrn.compacting')} />}
