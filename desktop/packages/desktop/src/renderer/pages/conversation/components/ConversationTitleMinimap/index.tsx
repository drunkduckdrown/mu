            ...
            <div className='conversation-minimap-list flex flex-col gap-6px'>
              {filteredItems.map((item, idx) => (
                ...
                >
                  ...
                  >
                    <span className='me-4px'>{t('conversation.minimap.questionLabel')}</span>
                    {renderHighlightedText(item.questionRaw || item.question, normalizedKeyword)}
                  </div>
                  {item.answer && (
                    <div
                      ...
                      style={{ whiteSpace: 'normal', wordBreak: 'break-word' }}
                    >
                      <span className='me-4px'>{t('conversation.minimap.answerLabel')}</span>
                      {renderHighlightedText(item.answerRaw || item.answer, normalizedKeyword)}
                    </div>
                  )}
                </button>
              ))}
