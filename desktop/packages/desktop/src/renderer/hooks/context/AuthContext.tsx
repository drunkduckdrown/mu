...
/**
 * Why a sign-in failed. The login page turns the code into a sentence in the app language; `csrfError` is an expired
 * security token, `staleCache` a sign-in broken by cached browser data.
 */
...
interface LoginResult {
  success: boolean;
  /** The server's own message, for logs only: it is not in the app language. */
  message?: string;
  code?: LoginErrorCode;
