...
const ThoughtDisplay: React.FC<ThoughtDisplayProps> = ({
  ...
  // Elapsed time in the app language, in brackets that follow the language too: "(1m 5s)", "（1分钟5秒）".
  const formatElapsedTime = (seconds: number): string =>
    t('conversation.thinking.elapsed', { time: formatDuration(seconds * 1000, i18n?.language, 'narrow') });
