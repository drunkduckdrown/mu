...
import type { HiveFocusRequest } from '@/renderer/pages/conversation/KyrnPanel';
import { ProjectPanelBody } from '@/renderer/components/layout/ProjectPanelHost';
    ...
    <>
      ...
      {!collapsed && (
        <Button
          type='text'
          size='mini'
          className='fixed z-101 !p-0 flex items-center justify-center transition-colors workspace-toggle-floating'
          style={{
            top: '50%',
