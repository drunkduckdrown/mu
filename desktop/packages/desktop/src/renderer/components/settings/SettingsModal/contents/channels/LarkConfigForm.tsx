      ...
      if (result.success) {
        ...
        Message.error(
          result.error
            ...
            : t('settings.lark.connectionFailed', 'Connection failed')
        );
      }
    } catch (error: any) {
      setCredentialsTested(false);
  ...
  return (
    <div className='flex flex-col gap-24px'>
      ...
      <PreferenceRow
        ...
        description={
          <span>
            <Trans t={t} i18nKey='settings.lark.appIdDesc' components={[devConsoleLink]} />
          </span>
        }
        required
      >
      ...
      <PreferenceRow
        ...
        description={
          <span>
            <Trans t={t} i18nKey='settings.lark.appSecretDesc' components={[devConsoleLink]} />
          </span>
        }
        required
      >
