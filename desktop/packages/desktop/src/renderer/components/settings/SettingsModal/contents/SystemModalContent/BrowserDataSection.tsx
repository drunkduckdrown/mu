    ...
    async (checked: boolean) => {
      ...
      try {
        ...
        if (result.success) {
          ...
          // The raw reason is for the log; the user gets the translated headline.
          if (result.msg) console.warn('[BrowserData] Agent control not changed:', result.msg);
      ...
      onOk: async () => {
        ...
        try {
          ...
          if (result.success) {
            ...
            if (result.msg) console.warn('[BrowserData] Browser data not cleared:', result.msg);
