 ...
 *
 * ButlerDiagnoseButton — the "Ask the Butler" chip mounted on conversation
 * error surfaces. Clicking it must hand a diagnosis prompt containing the
 * error text to the talk-to-butler flow.
 */
