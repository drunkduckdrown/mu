...
describe('titleForPath', () => {
  ...
  it('uses the login title on the login route only', () => {
    ...
    expect(titleForPath('/guid', t)).toBe('mu');
    expect(titleForPath('/conversation/abc', t)).toBe('mu');
    expect(titleForPath('/settings/agent', t)).toBe('mu');
  });
});

describe('DocumentTitle', () => {
  it('resets the title to the product name after leaving the login page', () => {
