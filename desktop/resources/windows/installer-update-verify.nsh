...
!macro AIONUI_OVERRIDE_APP_CANNOT_BE_CLOSED_MESSAGE
  ...
  ; One language per LangString: English (1033) and Simplified Chinese (2052) installers each show their own.
  LangString appCannotBeClosed 1033 "${AIONUI_MSG_APP_CANNOT_BE_CLOSED_EN}"
  LangString appCannotBeClosed 2052 "${AIONUI_MSG_APP_CANNOT_BE_CLOSED_ZH}"
